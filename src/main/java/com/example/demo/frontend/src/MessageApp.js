...
export default function MessageApp({ onGoToDiscussion, onGoToUsers }) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white p-4 flex-col">
      <button
        onClick={onGoToUsers}
        className="absolute top-4 right-4 bg-gray-200 text-gray-700 px-4 py-2 rounded-full hover:bg-gray-300 transition"
      >
        Our Users
      </button>
      {submitted ? (
